...
// War Feature Collections
const APPWRITE_WAR_MATCHES_COLLECTION_ID =
  import.meta.env.VITE_APPWRITE_WAR_MATCHES_COLLECTION_ID || 'war_matches';
const APPWRITE_WAR_QUEUE_COLLECTION_ID =
  import.meta.env.VITE_APPWRITE_WAR_QUEUE_COLLECTION_ID || 'war_queue';
const APPWRITE_WAR_LEADERBOARD_COLLECTION_ID =
  import.meta.env.VITE_APPWRITE_WAR_LEADERBOARD_COLLECTION_ID || 'war_leaderboard';
const APPWRITE_WAR_MATCH_HISTORY_COLLECTION_ID =
  import.meta.env.VITE_APPWRITE_WAR_MATCH_HISTORY_COLLECTION_ID || 'war_match_history';
const APPWRITE_WAR_CHALLENGE_ATTEMPTS_COLLECTION_ID =
  import.meta.env.VITE_APPWRITE_WAR_CHALLENGE_ATTEMPTS_COLLECTION_ID || 'war_challenge_attempts';
...
export const COLLECTIONS = {
  ...
  // War Feature Collections
  WAR_MATCHES: APPWRITE_WAR_MATCHES_COLLECTION_ID,
  WAR_QUEUE: APPWRITE_WAR_QUEUE_COLLECTION_ID,
  WAR_LEADERBOARD: APPWRITE_WAR_LEADERBOARD_COLLECTION_ID,
  WAR_MATCH_HISTORY: APPWRITE_WAR_MATCH_HISTORY_COLLECTION_ID,
  WAR_CHALLENGE_ATTEMPTS: APPWRITE_WAR_CHALLENGE_ATTEMPTS_COLLECTION_ID,
};
