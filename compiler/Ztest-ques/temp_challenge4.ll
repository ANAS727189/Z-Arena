...
@quotient = global double 0.000000e+00
@str.1 = internal constant [15 x i8] c"Quotient is: \0A\00"
...
entry0:
  ...
  %divtmp = fdiv double %a1, %b2
  %quotient = alloca double, align 8
  store double %divtmp, double* %quotient, align 8
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @str.1, i32 0, i32 0))
  %quotient3 = load double, double* %quotient, align 8
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @fmt.2, i32 0, i32 0), double %quotient3)
  ret i32 0
}
