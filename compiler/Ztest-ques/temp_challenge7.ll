...
@str.4 = internal constant [22 x i8] c"Sum from 1 to 7 is: \0A\00"
...
while_body2:                                      ; preds = %while_cond1
  ...
  %addtmp = fadd double %sum3, %i4
  store double %addtmp, double* %sum, align 8
  %i5 = load double, double* %i, align 8
  %addtmp6 = fadd double %i5, 1.000000e+00
  store double %addtmp6, double* %i, align 8
  br label %while_cond1

while_cont3:                                      ; preds = %while_cond1
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @str.4, i32 0, i32 0))
  %sum7 = load double, double* %sum, align 8
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @fmt.5, i32 0, i32 0), double %sum7)
  ret i32 0
}
