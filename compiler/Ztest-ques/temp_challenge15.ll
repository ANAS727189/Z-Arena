...
@str.5 = internal constant [29 x i8] c"Sum of digits of 98765 is: \0A\00"
...
define double @sumDigits(double %n) {
entry0:
...
while_body2:                                      ; preds = %while_cond1
  ...
  %addtmp = fadd double %sum5, %digit6
...
while_cont3:                                      ; preds = %while_cond1
  %sum10 = load double, double* %sum, align 8
  ret double %sum10
}
...
entry4:
  ...
  store double 9.876500e+04, double* %n, align 8
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @str.5, i32 0, i32 0))
  %n1 = load double, double* %n, align 8
  %calltmp = call double @sumDigits(double %n1)
